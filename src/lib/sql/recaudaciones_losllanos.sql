-- ==============================================================================
-- Archivo: Recaudaciones/recaudaciones_los_llanos.sql
-- Descripción: Total recaudado en dólares por día (últimos 30 días) para la Región Los Llanos.
-- ==============================================================================
...
WHERE
  ...
  AND p.REGION_NOMBRE = 'REGION LOS LLANOS'
GROUP BY
