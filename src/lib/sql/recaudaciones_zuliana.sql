-- ==============================================================================
-- Archivo: Recaudaciones/recaudaciones_zuliana.sql
-- Descripción: Total recaudado en dólares por día (últimos 30 días) para la Región Zuliana.
-- ==============================================================================
...
WHERE
  ...
  AND p.REGION_NOMBRE = 'REGION ZULIANA'
GROUP BY
