-- ==============================================================================
-- Archivo: Declaraciones/declaraciones_cobros_recuperaciones_aduanas.sql
-- Descripción: Conteo de declaraciones válidas por día (últimos 30 días) para la 
--              Región de la Unidad de Cobros y Recuperaciones de Aduanas.
-- ==============================================================================
...
WHERE
  ...
  AND Region.NOMBRE_REGION = 'REGION DE LA UNIDAD DE COBROS Y RECUPERACIONES DE ADUANAS'
