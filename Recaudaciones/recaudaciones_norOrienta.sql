-- ==============================================================================
-- Archivo: Recaudaciones/recaudaciones_nor_oriental.sql
-- Descripción: Total recaudado en dólares por día (últimos 30 días) para la Región Nor Oriental.
-- ==============================================================================
...
WHERE
  ...
  AND p.REGION_NOMBRE = 'REGION NOR ORIENTAL'
GROUP BY
