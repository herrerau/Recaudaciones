-- ==============================================================================
-- Archivo: Declaraciones/declaraciones_falcon.sql
-- Descripción: Conteo de declaraciones válidas por día (últimos 30 días) para la Región Falcón.
-- ==============================================================================
...
WHERE
  ...
  AND Region.NOMBRE_REGION = 'REGIÓN FALCÓN'
