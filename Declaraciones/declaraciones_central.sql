-- ==============================================================================
-- Archivo: Declaraciones/declaraciones_central.sql
-- Descripción: Conteo de declaraciones válidas por día (últimos 30 días) para la Región Central.
-- ==============================================================================
...
WHERE
  ...
  AND Region.NOMBRE_REGION = 'REGION CENTRAL'
