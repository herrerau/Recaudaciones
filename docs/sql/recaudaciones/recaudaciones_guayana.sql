-- ==============================================================================
-- Archivo: Recaudaciones/recaudaciones_guayana.sql
-- Descripción: Total recaudado en dólares por día (últimos 30 días) para la Región Guayana.
-- ==============================================================================
...
WHERE
  ...
  AND p.REGION_NOMBRE = 'REGION GUAYANA'
GROUP BY
