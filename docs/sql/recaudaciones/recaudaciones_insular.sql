-- ==============================================================================
-- Archivo: Recaudaciones/recaudaciones_insular.sql
-- Descripción: Total recaudado en dólares por día (últimos 30 días) para la Región Insular.
-- ==============================================================================
...
WHERE
  ...
  AND p.REGION_NOMBRE = 'REGION INSULAR'
GROUP BY
