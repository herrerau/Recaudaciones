-- ==============================================================================
-- Archivo: Recaudaciones/recaudaciones_libertador.sql
-- Descripción: Total recaudado en dólares por día (últimos 30 días) para la Región Libertador.
-- ==============================================================================
...
WHERE
  ...
  AND p.REGION_NOMBRE = 'REGION LIBERTADOR'
GROUP BY
