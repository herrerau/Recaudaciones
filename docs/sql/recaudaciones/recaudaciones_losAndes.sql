-- ==============================================================================
-- Archivo: Recaudaciones/recaudaciones_los_andes.sql
-- Descripción: Total recaudado en dólares por día (últimos 30 días) para la Región Los Andes.
-- ==============================================================================
...
WHERE
  ...
  AND p.REGION_NOMBRE = 'REGION LOS ANDES'
GROUP BY
