-- ==============================================================================
-- Archivo: Declaraciones/declaraciones_los_andes.sql
-- Descripción: Conteo de declaraciones válidas por día (últimos 30 días) para la Región Los Andes.
-- ==============================================================================
...
WHERE
  ...
  AND Region.NOMBRE_REGION = 'REGION LOS ANDES'
