-- ==============================================================================
-- Archivo: Declaraciones/declaraciones_especiales.sql
-- Descripción: Conteo de declaraciones válidas por día (últimos 30 días) para la Región de Contribuyentes Especiales.
-- ==============================================================================
...
WHERE
  ...
  AND Region.NOMBRE_REGION = 'REGION DE CONTRIBUYENTES ESPECIALES'
